...
from app.utils_hex import process_hex_messages
...
async def scan_anode():
    ...
    #
    lidar_task_1 = asyncio.create_task(lidar_worker(1, "", 50007, message_queue1))
    ...
    message_processing_task1 = asyncio.create_task(process_hex_messages(message_queue1))
